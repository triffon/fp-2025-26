...
## Задача 12 - Сливане с функция
Напишете функция `zip-with`, която приема функция и два списъка. Функцията да връща нов списък, който е равен на поелементното прилагане на функцията над двата списъка.

### Пример:
```scheme
(zip-with + '(4 8 5) '(3 9 1 2)) ; -> '(7 17 6)
```
