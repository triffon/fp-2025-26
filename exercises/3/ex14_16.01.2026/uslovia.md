# Допълнителни задачи 
Можете да решавате и на `Scheme` и на `Haskell`, както по ви харесва :).

### Задача 1
 Да се напише функция **generatePowers**, която по дадени
...
### Задача 2
 Път от корен до възел в двоично дърво кодираме с поредица от
...
```
```haskell
ghci> countCodes (Node 1 (Node 2 Empty (Node 3 Empty Empty)) (Node 4 (Node 6 Empty Empty) Empty))
3
```

### Задача 3
 Даден е списък от **n** списъци от числа **l<sub>1</sub>**, …, **l<sub>n</sub>** и
